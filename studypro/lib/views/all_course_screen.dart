    ...
    Positioned(
      ...
      child: Consumer<FavoriteProvider>(
        builder: (context, favoriteProvider, _) {
          final isFav = favoriteProvider.isFavorite(courseData['courseId']);
          return GestureDetector(
            onTap: () {
              favoriteProvider.toggleFavorite(courseData);
            },
            child: Icon(
              isFav ? Icons.star : Icons.star_border,
              color: isFav ? Color.fromARGB(224, 214, 125, 7) : Colors.white,
              size: 28,
            ),
          );
        },
